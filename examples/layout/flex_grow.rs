...
fn main() {
    let app = Application::new(|state, window| {
        ...
        Label::new("Flex Basis: 0px, Flex Grow: 1.0").build(state, window.entity(), |context| {
            context
                .set_flex_grow(1.0)
                .set_background_color(Color::rgb(50, 50, 120))
        });

        Label::new("Flex Basis: 200px, Flex Grow: 0.0").build(state, window.entity(), |context| {
            context
                .set_flex_basis(Length::Pixels(200.0))
                .set_background_color(Color::rgb(120, 50, 50))
        });

        Label::new("Flex Basis: 100px, Flex Grow: 2.0").build(state, window.entity(), |context| {
            context
                .set_flex_grow(2.0)
        ...
        Label::new("Flex Basis: 100px, Flex Grow: 0.0").build(state, window.entity(), |context| {
            context
                .set_flex_basis(Length::Pixels(200.0))
