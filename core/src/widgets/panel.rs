...
impl Widget for Panel {
    ...
    fn on_build(&mut self, mut builder: Builder) -> Self::Ret {
        ...
        self.arrow = Element::new().build(&mut header)
        ...
        // Label
        Label::new(&self.title).build(&mut header)
                .set_flex_grow(1.0)
                .set_hoverability(false)
                .set_focusability(false)
                .class("label")
        ...
        self.container1 = container1.entity();

        self.container2 = Element::new().build(&mut container1)
            .class("container2")
            .set_focusability(false)
